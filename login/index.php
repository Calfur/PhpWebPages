...
// Im Status 'KontodatenLesen' wechselt man in den Status 'Webshop' zur�ck durch... 
...
*/		
    ...
    case "KontodatenLesen":
		$titel = 'Kontodaten lesen';
			...
			include 'schutz\KontodatenLesen.inc.php'; // <-- Diese Datei ist zu erg�nzen. 2. von 2 Arbeiten
        break;			   
}
?>
